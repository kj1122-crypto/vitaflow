...
function AiCoach({ name }: { name: string }) {
  const [msgs, setMsgs] = useState<{ role: "user" | "assistant"; content: string }[]>([{ role: "assistant", content: `Good morning ${name}! I have reviewed your health data. Your WellScore is 82 and heart rate is steady. How can I help you today?` }])
