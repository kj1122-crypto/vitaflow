...
export default function Signup() {
  ...
  const progress = step === "account" ? 1 : step === "profile" ? 2 : 3
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ background: "#fff", border: "1px solid #E5E7EB", borderRadius: 20, padding: 28, boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
          ...
          <div style={{ display: "flex", gap: 6, marginBottom: 24 }}>
            {[1, 2, 3].map(n => (
              <div key={n} style={{
                ...
                background: n <= progress ? G : "#E5E7EB",
          ...
          <div style={{ display: "flex", gap: 6, marginBottom: 20 }}>
            {["Account", "Profile", "Done"].map((l, i) => (
              <div key={l} style={{ flex: 1, textAlign: "center", fontSize: 10, fontWeight: 600, color: i + 1 <= progress ? G : "#9CA3AF", textTransform: "uppercase" as const, letterSpacing: 0.5 }}>{l}</div>
            ))}
          </div>
          ...
          {step === "done" && (
            <div style={{ textAlign: "center" }}>
              ...
              <button
                ...
                style={{ width: "100%", padding: 14, borderRadius: 12, background: G, border: "none", color: "#fff", fontSize: 15, fontWeight: 700, cursor: "pointer" }}
              >
                Go to My Dashboard →
              </button>
            </div>
