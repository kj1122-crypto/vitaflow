...
export async function POST(req: NextRequest) {
  try {
    ...
    const response = await anthropic.messages.create({
      ...
      max_tokens: 600,
      system: `You are VellCare AI, a warm and caring AI health companion for the VellCareAI app — SUPER AI HEALTH ECOSYSTEM by VCAI.
...
Give practical caring personalised advice. Keep responses under 100 words and easy to understand for all ages.`,
